...
if __name__ == "__main__":
    ...
    test_loaders = [torch.utils.data.DataLoader(test_dataset, batch_size=args.batch_size, drop_last=False, shuffle=False,num_workers=4) for test_dataset in test_datasets]
